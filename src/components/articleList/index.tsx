    ...
    <Fragment>
      {pageList.map((pageItem, pageIndex) => (
        <div className='page-item-container' key={pageItem.id}>
          <Link className='image-container' to={`/article/${pageItem.id}`}>
            <Image
          ...
          <div className='page-content'>
            ...
            {pageIndex === pageList.length - 1 ? (
              <Link to={`/article/${pageItem.id}`} className='page-title' ref={lastPageRef}>
                {pageItem.articleTitle}
              </Link>
            ) : (
              <Link className='page-title' to={`/article/${pageItem.id}`}>
                {pageItem.articleTitle}
              </Link>
            )}
            ...
            <Link to={`/article/${pageItem.id}`} className='page-brief'>
